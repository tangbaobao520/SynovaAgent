# Task Brief: D601 任务看板映射校准 + L1 跨层违规扫描

> 生成: 2026-09-08 | 任务: D601 | 认领: dsh-cto（🧭 synova-cto，创始人直接派单）
...
- task-state/D601.json + 本 brief + memory/notes/proposed/ 决策 note（铁律 49 沉淀）
不做什么：
- 不改 src/（产品代码归编码线，红线）
