...
## Done 标准
- [ ] 入口可触达: `npx vitest run tests/routes/d948-department-visibility.test.ts tests/routes/auth.test.ts tests/middleware/auth.test.ts tests/middleware/rbac.test.ts` 退出码 0（140 用例全绿）
