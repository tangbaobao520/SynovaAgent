# Task Brief: Task 4.3: I8 护城河依赖度

> 生成: 2026-06-27 21:40:56 | 分支: feat/prompt-architecture | as any: 0
...
Phase 4。I8护城河依赖度。聚合哨兵，引用I3+I4结果计算护城河依赖度。extensions/sentinels/moat-dependency/（GA诊断/哨兵/基础设施）？触及哪层？该层现有模块？新增/替换/扩展？
