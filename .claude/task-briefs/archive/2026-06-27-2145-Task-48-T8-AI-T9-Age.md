# Task Brief: Task 4.8: T8 AI投入产出比 T9 人Agent混合边界

> 生成: 2026-06-27 21:45:30 | 分支: feat/prompt-architecture | as any: 0
...
Phase 4 技术层。（GA诊断/哨兵/基础设施）？触及哪层？该层现有模块？新增/替换/扩展？

### b) 文件审计
新建。。关系：新建。 expert/ sentinel/ extensions/ knowledge/ theory/ skills/ 中。列出已有文件驱动模块。关系: 复用 / 扩展 / 新建 / 冲突
...
做什么：
1. 创建哨兵目录 + manifest + aggregate + compute
