...
> 打开即真相。生成: 2026-08-27 12:52:36 | 数据源指纹: e464fb747287

<!-- CTO-HEALTH:AUTO:START -->
## CTO 健康仪表盘（第③面）— 自动区
> 生成: 2026-08-27 12:52:35 | 数据源: bypass.log / pre-commit-failures.log / AUDIT-FINDINGS-LEDGER
...
| 事件 | 全量 | 24h 内 |
|------|:---:|:---:|
| COMMITTED（正常提交） | 523 | 25 |
| BLOCKED（被门禁拒绝） | 126 | 1 |
| DEGRADED（降级放行） | 44 | 3 |
| TIMEOUT（超时） | 3 | 0 |
| **detected-bypass（真绕过）** | **9** | **0** |

近 7 天事件: 2026-08-21:45 | 2026-08-22:106 | 2026-08-23:45 | 2026-08-24:40 | 2026-08-25:84 | 2026-08-26:24 | 2026-08-27:29
...
> 📦 历史任务（已折叠）: **159** 个（git log 全项目派生，非 task-state 登记；12 个有审计报告）
...
- 🔴 **12 个孤儿 worktree 有待收尾**（独有提交未合并进 main，可能是未收尾的交付）
  - /Users/wane/SynovaAgent (分支 refs/heads/feat/d505-impl, 1 个独有提交)
  ...
  - /Users/wane/SynovaAgent/.wt-d534-d535 (分支 refs/heads/feat/d534-d535-stage1-cont, 10 个独有提交)
  - /Users/wane/SynovaAgent/.wt-D537 (分支 refs/heads/fix/d537-tower-parallel-commit-friction, 9 个独有提交)
