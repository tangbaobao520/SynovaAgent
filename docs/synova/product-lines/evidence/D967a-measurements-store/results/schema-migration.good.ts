...
import { graphTriplesRebuildMigration } from './migrations/002-graph-triples-rebuild';
import { measurementsTableMigration } from './migrations/003-measurements-table';
...
const migrations: Migration[] = [
  ...
  // D967 P7: 生产库 graph_triples 整表结构漂移（id INTEGER PK / 无 props）→ 整表重建回 canonical
  graphTriplesRebuildMigration,
  // D967 ①: 哨兵时序层 measurements 表（append-only）
