...
const MOCK_CONVERSATIONS: ConversationInfo[] = [
  { id: 'conv-1', title: '为什么现金流在恶化？', preview: '分析了现金流趋势和应...', updatedAt: new Date().toISOString() },
  { id: 'conv-2', title: '团队协作分析', preview: '识别了部门间协作障碍...', updatedAt: new Date().toISOString() },
