...
exports.generateAugmentationCard = generateAugmentationCard;
const memory_store_1 = require("../knowledge-sharing/memory-store");
 ...
 */
function generateAugmentationCard(params) {
    const { taskCategory, targetRoleId, teamId, maxCards = 3 } = params;
    const now = new Date().toISOString();
    // Get all team memories
    const allMemories = (0, memory_store_1.getTeamMemories)(teamId);
