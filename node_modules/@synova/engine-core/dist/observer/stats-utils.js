...
exports.wilsonCILower = wilsonCILower;
 ...
 */
function wilsonCILower(observed, n, z = 1.96) {
    if (n <= 0)
        return 0;
    const p = observed / n;
 ...
 */
function welchTTest(before, after) {
 ...
 * 足够精确到判断 p < 0.05
 */
function specialBeta(a, alpha, bet) {
 ...
 * 连分式法计算不完全 Beta 函数
 */
function incompleteBetaCF(x, a, b) {
    if (x < 0 || x > 1)
        return x < 0 ? 0 : 1;
    if (x === 0 || x === 1)
        return x;
