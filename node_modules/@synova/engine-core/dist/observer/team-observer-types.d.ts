...
export type GapId = 'division_of_labor' | 'information_flow' | 'authority_governance' | 'trust_incentive' | 'knowledge_sharing' | 'external_interface';
export declare const GAP_LABELS: Record<GapId, string>;
