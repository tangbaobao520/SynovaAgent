...
exports.generateMultiRoleNarrative = generateMultiRoleNarrative;
const logger_1 = require("../../infra/logger");
const log = (0, logger_1.createLogger)('engine-server/pipeline/diagnosis/auto-interpreter');
/** 单路 LLM 超时 ms */
...
// Fallback narrative
// ====================================================================
function buildFallbackNarrative(summary) {
 ...
 */
async function generateMultiRoleNarrative(diagnosis) {
...
function withTimeout(promise, ms) {
    return Promise.race([
        promise,
        new Promise((_, reject) => setTimeout(() => reject(new Error('LLM_CALL_TIMEOUT')), ms)),
    ]);
}
