...
exports.buildIntervieweeProfile = buildIntervieweeProfile;
exports.listRoleTypes = listRoleTypes;
exports.suggestRoleType = suggestRoleType;
exports.getDimensionPriority = getDimensionPriority;
exports.aggregateTeamPriorities = aggregateTeamPriorities;
// ====================================================================
// 内置角色画像库
// ====================================================================
...
// ====================================================================
/** 根据输入构建角色画像 */
function buildIntervieweeProfile(input) {
...
/** 获取内置角色类型列表 */
function listRoleTypes() {
    return Object.keys(DEFAULT_PROFILES);
}
/** 根据职责关键词推荐角色类型 */
function suggestRoleType(responsibilities) {
    const scored = Object.entries(DEFAULT_PROFILES).map(([type, profile]) => {
        const overlap = responsibilities.filter(r => profile.responsibilities.some(pr => pr.includes(r) || r.includes(pr))).length;
        return { type: type, score: overlap };
    });
    return scored
        .filter(s => s.score > 0)
...
/** 为角色生成推荐的诊断维度优先级 */
function getDimensionPriority(profile, allDimensions) {
    // 先排角色关心的维度，后排其余维度
...
/** 多角色聚合：计算团队级别的维度优先级 */
function aggregateTeamPriorities(profiles, allDimensions) {
...
//# sourceMappingURL=interviewee-profile.js.map