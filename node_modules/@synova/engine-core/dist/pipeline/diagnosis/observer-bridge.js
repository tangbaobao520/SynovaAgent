...
exports.bridgeHealthSnapshot = bridgeHealthSnapshot;
exports.bridgeAndRecord = bridgeAndRecord;
const gap_recorder_1 = require("./gap-recorder");
// ====================================================================
// Mapping: GapId (observer) → GapDimension (diagnosis)
// ====================================================================
const OBSERVER_TO_DIAGNOSIS = {
...
function metricToEngineScore(metric) {
...
function buildRuntimeSourceBreakdown(metric) {
    return {
        runtime_events: 0.3,
        conflict_rate: 0.25,
        escalate_rate: 0.25,
 ...
 */
function bridgeHealthSnapshot(health) {
 ...
 */
function bridgeAndRecord(health) {
    const snapshot = bridgeHealthSnapshot(health);
    if (snapshot) {
        (0, gap_recorder_1.recordGapSnapshot)(snapshot);
    }
    return snapshot;
}
//# sourceMappingURL=observer-bridge.js.map