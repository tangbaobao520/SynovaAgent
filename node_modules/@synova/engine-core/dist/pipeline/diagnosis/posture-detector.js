...
exports.POSTURE_QUESTIONS = void 0;
exports.detectPosture = detectPosture;
exports.defaultDetection = defaultDetection;
/** Phase 0 姿态问卷定义（供前端渲染） */
exports.POSTURE_QUESTIONS = [
    {
        id: 'q1Goal',
 ...
 */
function detectPosture(answers) {
    const reasons = [];
    // 主导信号：Q1
    let posture;
...
//# sourceMappingURL=posture-detector.js.map