...
exports.queryQuestions = queryQuestions;
exports.countByDimension = countByDimension;
exports.countByRole = countByRole;
exports.addCustomQuestion = addCustomQuestion;
exports.addCustomQuestions = addCustomQuestions;
exports.removeCustomQuestion = removeCustomQuestion;
exports.getQuestionCount = getQuestionCount;
exports.clearCustomQuestions = clearCustomQuestions;
exports.getSeedQuestions = getSeedQuestions;
...
function queryQuestions(filter = {}) {
    ...
    if (filter.keyword) {
        ...
        results = results.filter(q => q.text.toLowerCase().includes(kw) ||
...
/** 为特定角色生成诊断问卷 */
function generateQuestionnaire(targetRole, phase = 1, maxQuestions = 15) {
    // 优先匹配角色专属问题，再匹配通用问题
