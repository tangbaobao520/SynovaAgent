...
/** 战略姿态 */
export type StrategicPosture = 'moat_builder' | 'steady_operator' | 'survival_seeker' | 'lifestyle_keeper' | 'mission_focus';
/** Phase 0 姿态识别问卷答案 */
...
export declare enum DiagnosisErrorCode {
...
export declare enum DiagnosisPermissionLevel {
    EVERYONE = 0,
    ORG_MEMBER = 1,
...
/** 专家类型 */
export type ExpertType = 'strategic_analyst' | 'org_diagnostician' | 'financial_analyst' | 'tech_architect' | 'action_advisor' | 'marketing_analyst';
/** 专家发现 */
