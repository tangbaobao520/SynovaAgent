...
exports.extractSlimPersona = extractSlimPersona;
exports.formatSlimForPrompt = formatSlimForPrompt;
exports.batchExtractSlim = batchExtractSlim;
// ================================================================
// SAGER 阈值常量
// ================================================================
 ...
 * 5. 评估退化风险
 */
function extractSlimPersona(frameworks, roleId) {
 ...
 */
function formatSlimForPrompt(output) {
    if (output.slimMentalModels.length === 0) {
        return '';
    }
    const lines = output.slimMentalModels.map(m => `· ${m.name}(${m.source}): ${m.description.slice(0, 60)}`);
    // 退化警告
 ...
 */
function batchExtractSlim(frameworksByRole) {
    const result = {};
