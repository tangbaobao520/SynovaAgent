...
class RulingCache {
     ...
     */
    set(key, result, protocolVersion, ttlMs = DEFAULT_TTL_MS) {
    ...
    /** 按协议版本全量失效 */
    invalidateByVersion(protocolVersion) {
...
exports.RulingCache = RulingCache;
