...
exports.generateDetailPage = generateDetailPage;
function generateDetailPage(input) {
    const modeIcons = {
    ...
    for (const [mode, score] of Object.entries(input.modeScores)) {
        ...
        lines.push(`- **${mode}**: ${bar} ${score.toFixed(0)}分`);
    }
    lines.push('');
...
function getModeReason(mode, input) {
    const reasons = {
...
function getContraindications(input) {
    const contras = [];
...
//# sourceMappingURL=detail-page-generator.js.map