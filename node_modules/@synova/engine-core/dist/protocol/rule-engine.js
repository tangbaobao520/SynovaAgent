...
exports.RuleEngine = exports.IRON_LAWS = void 0;
// ============================================================
...
class RuleEngine {
     ...
     * 返回所有匹配的铁律违规
     */
    checkIronLaws(message) {
        const violations = [];
        for (const rule of exports.IRON_LAWS) {
    ...
    match(message, protocol) {
        ...
        const gapValues = {
            ...
            external_interface: getGapStr(gaps.external_interface?.isolation, 'sandbox'),
        };
    ...
    getActiveRules(protocol) {
        ...
        for (const [gapName, gapValue] of Object.entries(gapValues)) {
            ...
            const valueRules = gapRules[gapValue];
            if (valueRules)
                active.push(...valueRules);
            const defaultRules = gapRules['default'];
            if (defaultRules)
                active.push(...defaultRules);
        }
        return active;
    }
}
