...
export interface TrustProtocol {
    ...
    update: {
        mechanism: 'merit_based' | 'seniority_based' | 'fixed';
        meritRules: MeritRule[];
        cooldownHours: number;
    };
    consequences: {
        high: TrustConsequence;
        medium: TrustConsequence;
        low: TrustConsequence;
        probation: TrustConsequence;
    };
    degradationTriggers: DegradationTrigger[];
    recovery: {
        consecutiveGoodSignalsNeeded: number;
        probationDaysNeeded: number;
    };
}
...
export interface ExternalInterfaceProtocol {
    ...
    audit: {
        enabled: boolean;
        logAllExternalCalls: boolean;
        retentionDays: number;
    };
    dataProtection: {
        noRawUserDataExport: boolean;
        sanitizeBeforeExternal: boolean;
    };
