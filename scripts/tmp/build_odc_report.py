...
<div class="highlight">
<h3 style="margin-top:0;">核心问题</h3>
<p><strong>1.</strong> 当识别出一个非共识机会 (Non-Consensus Opportunity, NCO)，企业是否有能力消化它？<br>
<strong>2.</strong> 当企业濒死时，如何判断是否应该切换到背水一战框架，押注唯一可见的非共识路径？</p>
</div>
"""
