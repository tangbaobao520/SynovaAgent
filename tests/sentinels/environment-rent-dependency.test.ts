...
it("多个指标加总", () => { const r = computeRentDependencyIndex([{type:"subsidy",value:50},{type:"revenue",value:100},{type:"resource_rent",value:30}]); expect(r.index).toBeGreaterThan(0.3); expect(r.signals.length).toBeGreaterThan(0); });
